...
var Card = React.createClass({
  render: function() {
    return (
      <div className="col-sm-2">
        <h1><img className="img-responsive" src={"http://golearntocode.com/images/cards/"+this.props.number+".png"} /></h1>
      </div>
    )
  }
})
  ...
  render: function() {
    return (
      <div>
        ...
        <div className="row">
          <Card number={this.state.hand[0]}/>
          <Card number={this.state.hand[1]}/>
          <Card number={this.state.hand[2]}/>
          <Card number={this.state.hand[3]}/>
          <Card number={this.state.hand[4]}/>
          <DealButton dealClicked={this.dealClicked}/>
        </div>
      </div>
    )
  }
